...
const reviews = [
  ...
  { name: 'Martin Dvořák', time: 'před 2 měsíci', rating: 5, text: 'Jako developer jsme zadali 8 bytů najednou. Koordinace perfektní, každý byt vypadá stejně dobře. Cena za jednotku je výrazně nižší než bourání.' },
]
