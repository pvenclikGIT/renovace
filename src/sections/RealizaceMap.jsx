...
const LOCATIONS = [
  ...
  { id: 'p2',  label: 'Praha 2',         area: 'Vinohrady & Nusle',              zone: 'Praha',         lat: 50.0732, lng: 14.4378, count: 14,
    story: 'Secesní domy s vysokými stropy a koupelnami z osmdesátek. Stěrka tady funguje jako designový restart – bez bourání, bez chaosu.',
    tag: 'Vilová čtvrť', avgDays: 3, avgM2: 11 },
  { id: 'p3',  label: 'Praha 3',         area: 'Žižkov & Vinohrady',             zone: 'Praha',         lat: 50.0841, lng: 14.4596, count: 19,
    story: 'Žižkov je naší nejaktivnější oblastí. Cihlové domy i panelové bloky – stěrka zde nahradila nevzhlednou dlažbu za pouhé dva dny.',
  ...
  { id: 'kladno',     label: 'Kladno',          area: 'Kladno & Slaný',                zone: 'Střední Čechy', lat: 50.1437, lng: 14.1038, count: 7,
    story: 'Průmyslové Kladno se mění na moderní město. Nová generace majitelů chce bydlení na úrovni – stěrka je první krok.',
  ...
  { id: 'pribram',    label: 'Příbram',         area: 'Příbram & Dobříš',               zone: 'Střední Čechy', lat: 49.6940, lng: 14.0081, count: 5,
    story: 'Jihozápad středočeského kraje. Přijedeme, realizujeme ve 3 dnech a jedeme zpět – přesně dle dohody.',
  ...
  { id: 'ricany',     label: 'Říčany',          area: 'Říčany & Průhonice & Jesenice',  zone: 'Střední Čechy', lat: 49.9921, lng: 14.6537, count: 6,
    story: 'Prémiový pražský suburbanon. Rodinné domy od 5 milionů výš – koupelna musí být na úrovni a stěrka přesně sedí.',
    ...
    <section id="map" className={styles.section}>
      <FadeIn>
        <div className={styles.sectionHead}>
          ...
          <p className={styles.lead}>Praha a celý Středočeský kraj. Klikněte na oblast – uvidíte detaily.</p>
        </div>
      </FadeIn>
            ...
            {active ? (
              ...
              >
                ...
                <div className={styles.panelStats}>
                  ...
                  <div className={styles.panelStat}>
                    <div className={styles.panelStatVal}>{active.avgDays} dny</div>
                    <div className={styles.panelStatLabel}>Délka realizace</div>
                  </div>
                  <div className={styles.panelStatDiv} />
                  <div className={styles.panelStat}>
