...
const items = [
  ...
  { src: '/renovace/images/podlaha-04.jpg', label: 'Microcement: rohová vana a dvojité umývadlo', sub: 'Praha západ', span: 'large' },
  { src: '/renovace/images/real-05.jpg', label: 'Industriální koupelna: cihla a stěrka', sub: 'Praha 2', span: 'small' },
  ...
  { src: '/renovace/images/real-02.jpg', label: 'Rustikální koupelna: dřevo, kámen a stěrka', sub: 'Praha 9', span: 'medium' },
  { src: '/renovace/images/podlaha-01.jpg', label: 'Cementová stěrka, podlaha i stěny', sub: 'Praha 3', span: 'medium' },
  { src: '/renovace/images/podlaha-09.jpg', label: 'Rohová vana, dřevo a stěrka', sub: 'Praha západ', span: 'medium' },
  // Row 4-5: hero (6 cols × 2 rows) + 2×2 smalls on right
  { src: '/renovace/images/real-11.jpg', label: 'Stěrka, dřevěný nábytek a kamenné umývadlo', sub: 'Praha západ', span: 'large' },
  ...
  { src: '/renovace/images/real-12.jpg', label: 'Stěrka, sprchový kout a dvojité umývadlo', sub: 'Praha 3', span: 'small' },
