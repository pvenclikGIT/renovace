...
const myths = [
  ...
  },
  {
    ...
    truth: 'Správně provedená stěrka s kvalitním polyuretanovým lakem vydrží 10 až 15 let při normálním používání. Na webu zveřejňujeme reference z realizací starých 8 a více let. Stále vypadají jako nové.',
  },
  {
  ...
  {
    myth: 'V koupelně to nepůjde, je tam příliš vlhko',
